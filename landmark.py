...
Original file is located at
    https://colab.research.google.com/drive/1jBpfR8c395AFI0wlXBLHPNYDKQYORzCI
"""
...
mainpath = "landmark-recognition-2021"
image_path = []
images_pixels = []
...
for i in range(0,len(image_ids)):
    ...
    if os.path.exists(finalpath):
        ...
        if img_pix is not None:
            ...
            print(f"Failed to load image: {finalpath}")
    else:
        print(f"Image file not found: {finalpath}")
